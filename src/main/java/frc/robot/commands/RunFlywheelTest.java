 ...
 */
public class RunFlywheelTest extends CommandBase {
    Flywheel flywheel;
    boolean done;

    /** Constructor for RunFlywheel */
    public RunFlywheelTest(Flywheel flywheelSubsystem) {
    ...
    public void initialize() {
        flywheel.setVelocity(SmartDashboard.getNumber("Flywheel setpoint", Constants.FLYWHEEL_SPEED));
        done = true;
    }
