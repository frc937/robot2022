...
public class LiftSkrunglesOverride extends CommandBase {
    SkrungleLifter skrungleLifter;

  /** Creates a new LiftSkrungles. */
  public LiftSkrunglesOverride(SkrungleLifter skrungleLifter) {
  ...
  public void initialize() {
    this.skrungleLifter.liftSkrunglesOverride();
  }
