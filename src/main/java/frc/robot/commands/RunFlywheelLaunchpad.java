 ...
 */
public class RunFlywheelLaunchpad extends CommandBase {
    Flywheel flywheel;
    boolean done;

    /** Constructor for RunFlywheel */
    public RunFlywheelLaunchpad(Flywheel flywheelSubsystem) {
    ...
    public void initialize() {
        flywheel.setVelocity(Constants.FLYWHEEL_SPEED_LAUNCHPAD);
        done = true;
    }
